...
private:
  netft::Config read_config()
  {
    ...
    parameter(private_node_, "http_port", parameters.http_port, parameters.http_port);
    ...
    parameter(private_node_, "configuration_connect_timeout",
              parameters.configuration_connect_timeout,
              parameters.configuration_connect_timeout);
    parameter(private_node_, "configuration_timeout", parameters.configuration_timeout,
              parameters.configuration_timeout);
    parameter(private_node_, "reconnect_initial_delay", parameters.reconnect_initial_delay,
